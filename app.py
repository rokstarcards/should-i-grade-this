...
if uploaded_file:
    ...
    adjusted_x = st.slider('Adjust X (left corner)', 0, 1000, detected_card_rect[0], step=1)
    adjusted_y = st.slider('Adjust Y (top corner)', 0, 1000, detected_card_rect[1], step=1)
    adjusted_w = st.slider('Adjust Width', 0, 1000, detected_card_rect[2], step=1)
    adjusted_h = st.slider('Adjust Height', 0, 1000, detected_card_rect[3], step=1)
    ...
    st.write(f"Centering Score: {center
